 ...
 * <code>
 *     termcolor::initialize(STDOUT_FILENO);
 *     termcolor::enable_if(cout, isatty(STDOUT_FILENO) && !NO_COLOR);
 * </code>
 *
...
// global control
bool initialize(int terminalFd); ///< initializes terminal behind given file descriptor (expects terminalFd to be 0, 1, 2).
