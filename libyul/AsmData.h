...
struct Assignment { langutil::SourceLocation location; std::vector<Identifier> variableNames; Expression value; };
...
struct VariableDeclaration { langutil::SourceLocation location; TypedNameList variables; boost::optional<Expression> value; };
...
struct If { langutil::SourceLocation location; Expression condition; Block body; };
/// Switch case or default case
struct Case { langutil::SourceLocation location; boost::optional<Literal> value; Block body; };
/// Switch statement
struct Switch { langutil::SourceLocation location; Expression expression; std::vector<Case> cases; };
struct ForLoop { langutil::SourceLocation location; Block pre; Expression condition; Block post; Block body; };
